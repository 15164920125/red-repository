...
//		String result = restTemplate.postForObject(url, request, String.class);
	...
	public static ResourceBundle mobileConfig = ResourceBundle.getBundle("application");
	public static ResourceBundle mobileParam = ResourceBundle.getBundle("bootstrap");
	...
	public static String getZhongTaiUrl(String serviceName, HttpServletRequest request) {
		...
		if (StringUtils.isEmpty(serviceUrl) || StringUtils.isEmpty(servicePath)) {
			throw new RuntimeException("application.properties配置文件中,找不到key:" + serviceName);
		}
	...
	public static String getToken(String tokenName) {
		try {
			...
			throw new RuntimeException("application.properties配置文件中,找不到key:" + tokenName);
		}
	}
